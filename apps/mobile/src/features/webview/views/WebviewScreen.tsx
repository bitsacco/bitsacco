...
const WebViewScreen: React.FC = () => {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: "#1A202C" }]}>
      ...
      {!isConnected && (
        <View style={[styles.noInternetBanner, { paddingTop: insets.top > 0 ? 0 : 8 }]}>
          <Text style={styles.noInternetBannerText}>No Internet connection. Please Reload screen</Text>
        </View>
      )}
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl
            ...
            titleColor={'#FFFFFF'}
            progressBackgroundColor={Platform.OS === 'android' ? '#1e293b' : undefined}
          />
        }
      >
        <WebView
