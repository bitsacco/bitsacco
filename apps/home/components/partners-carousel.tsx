...
export function PartnersCarousel({ partners }: PartnersCarouselProps) {
  ...
  return (
    <div className="relative mx-auto max-w-7xl">
      ...
      <button
        onClick={() => scroll('left')}
        className={`absolute left-0 top-1/2 z-10 -translate-y-1/2 rounded-full bg-white p-2 shadow-lg transition-opacity dark:bg-gray-800 ${
      ...
      <button
        ...
        className={`absolute right-0 top-1/2 z-10 -translate-y-1/2 rounded-full bg-white p-2 shadow-lg transition-opacity dark:bg-gray-800 ${
      ...
      <div
        ...
        className="flex gap-6 overflow-x-auto px-12 scrollbar-none sm:gap-8 md:gap-12"
      >
